...
public class AppConstant {
    ...
    public static final String ALARM_RECEIVER_INTENT_TRIGGER = "com.workout.height.alarm.action.trigger";
    ...
    public static final String WORKOUT_30_DAYS_PLAN = "UNDER_19_YEAR_WORKOUT";
    public static final String WORKOUT_21_DAYS_PLAN = "ABOVE_19_YEAR_WORKOUT";
    public static final String WORKOUT_45_DAYS_PLAN = "WORKOUT_45_DAYS_PLAN";
    ...
    public static final String CALC_WEIGHT_UNIT = "weight_unit";
    ...
    public static final float MIN_HEIGHT_CM = 30f;
